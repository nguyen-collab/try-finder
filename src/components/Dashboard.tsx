          ...
          <section className="w-full flex flex-col items-center gap-4">
            <div className="w-full flex flex-col lg:flex-row items-end gap-4">
              ...
              <div className="flex-1 flex flex-col items-start gap-[13.1px] w-full">
                ...
                <div className="w-full rounded-[10.46px] bg-[#151515] border-gray-1500 border-solid border-[0.9px] flex items-center justify-between py-[8.7px] px-[10.5px] gap-5 text-[14.17px]">
                  <div className="flex items-center gap-[8.7px]">
                    <AISearchIcon />
                    <span className="text-left tracking-num--0_01 leading-[19.62px] opacity-[0.4]">
                      e.g. LinkedIn URL, Job Title,
