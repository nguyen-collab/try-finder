  ...
  return (
    <main className="w-full bg-gray-500 flex flex-col items-start gap-3.5 text-white font-inter-variable text-base pb-20">
      ...
      <section className="w-full rounded-[13.08px] bg-gray-200 border-gray-1300 border-solid border-[0.7px] flex flex-col items-start p-[15px] gap-[15px] font-inter">
        ...
        <div className="w-full flex flex-col items-start gap-3 text-sm font-inter-variable">
      ...
      <section className="w-full rounded-[13.08px] bg-gray-200 border-gray-1300 border-solid border-[0.7px] flex flex-col items-start p-[15px] gap-4 text-xs">
        ...
        <div className="w-full flex flex-col items-start gap-3">
          <div className="w-full flex items-center justify-between gap-5">
            <label className="tracking-num--0_01 leading-3 font-medium opacity-[0.75] text-sm">
              Current Password
            </label>
          </div>
        ...
        >
          <div className="space-y-4">
            ...
            <div className="w-full rounded-[13.08px] bg-firebrick-300 border-firebrick-200 border-solid border flex items-center p-2.5 text-sm">
              <p className="w-full tracking-num--0_01 leading-5 text-base">
